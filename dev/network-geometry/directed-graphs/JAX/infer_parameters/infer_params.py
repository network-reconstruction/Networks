...
class DirectedS1Fitter:
    ...
    def __init__(self, 
                 ...
                 EXP_CLUST_NB_INTEGRATION_MC_STEPS: int = 500, 
    ...
    def infer_parameters(self) -> None:
        ...
        if not self.CUSTOM_BETA:
            ...
            while True:
                ...
                #bisection method to find beta, so min_n ((beta_max - beta_min)/2^n) <= Beta_Threshold of number of iterations eg:  ceiling(log_2((beta_max - beta_min)/ beta_threshold)) = n
    ...
    def save_inferred_parameters(self, save_path = "") -> None:
        ...
        """
        if self.verbose:
            self.logger.info("Saving inferred parameters ...")
